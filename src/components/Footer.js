      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold mb-4">Anurag Birendra Singh</h3>
            <p className="text-gray-400 mb-4 max-w-md">
              Full Stack Developer with hands-on production experience building real-world applications. 
              Currently working at EduKyu and specializing in MERN stack, Next.js, and AI-powered solutions.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>singhanuragbirendra@gmail.com</p>
              <p>+91 8094999565</p>
              <p>Noida, India</p>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Anurag Birendra Singh. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <p className="text-gray-400 text-sm">
              Built with Next.js, React, MERN Stack & Tailwind CSS
            </p>
          </div>
        </div>
      </div>
